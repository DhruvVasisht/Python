...
class Node:
    def _init_(self, data1, data2, data3, data4):
        self.data1 = data1
        self.data2 = data2
        self.data3 = data3
        self.data4 = data4
...
class LinkedList:
    ...
    def append(self, data1, data2, data3, data4):
        new_node = Node(data1, data2, data3, data4) # type: ignore
        ...
        if self.head is None:
            ...
            if prev_node is None:
                ...
                new_node.next = current_node# type: ignore
    ...
    def delete(self, data1, data2, data3, data4):
        ...
        while current_node is not None:
            if current_node.data1 == data1 and current_node.data2 == data2 and current_node.data3 == data3 and current_node.data4 == data4:
                prev_node.next = current_node.next# type: ignore
                return
            prev_node = current_node
            current_node = current_node.next
